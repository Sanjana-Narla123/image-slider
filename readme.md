...
🌐 Live Demo
👉 Click to view the slider

🚀 Features

Smooth slide transitions (CSS-powered)

Next / Previous controls + dot indicators
...
JavaScript (ES6+) — no external libraries by default

Optional: tiny swipe helper (or use Pointer Events)
